...
<div class="section">
  ...
  <div style="display: inline-flex;flex-direction: row;justify-content: space-between;align-items: baseline;width: inherit;">
    <h1>{{$lista->nome}}</h1>
    <button type="button" class="btn" data-target="#modalExemplo" data-salvar onclick="chamaPopUpIntegrantes()">Intengrantes</button>
                        ...
                        <div class="card-front">
                            <div class="center-wrap">
                                ...
                                <div class="section text-center">
                                    ...
                                    <h4 class="mb-4 pb-3">Cod. Convite: <strong>{{$lista->codListParticipante}}</strong></h4>
                                    @if(isset($lista->participantes))
